...
import { getFeaturedBook } from "@/lib/mockBooks";
...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-[50vh] sm:h-[65vh] md:h-[85vh] min-h-[400px] max-h-[850px] flex items-center select-none overflow-hidden bg-black">
      ...
      <div className="relative z-20 px-4 md:px-16 w-full max-w-[800px] mt-16 md:mt-24">
        ...
        >
          ...
          {/* Title */}
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight text-white leading-none drop-shadow-[0_4px_8px_rgba(0,0,0,0.95)]">
            {book.title}
          </h1>
